  ...
  return (
    <>
      <div className="text-large flex flex-col justify-center gap-2 overflow-y-auto">
        ...
        <p>
          Really clean clicking sound (click-change-tab), Creative Commons 0, BiORNADE&nbsp;
        ...
        <p>
          Coin click (click-coin), Creative Commons 0, The_Frisbee_of_Peace&nbsp;
        ...
        <p>
          Miner background noise (bgNoiseMiner) — Pickaxe 1/4, CC Attribution 4.0, TechspiredMinds&nbsp;
        ...
        <p>
          Farmer background noise (bgNoiseFarmer) — 01130 chicken hen 2.wav, CC Attribution 4.0, Robinhood76&nbsp;
        ...
        <p>
          Forum background noise (bgNoiseForum) — Crowd.wav, CC Attribution 4.0, Haykrich&nbsp;
