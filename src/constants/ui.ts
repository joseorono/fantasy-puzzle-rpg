...
// Health bar colors by orb color
export const HEALTH_BAR_COLORS: Record<OrbColor, string> = {
...
// Orb color classes for styling
export const ORB_COLOR_CLASSES: Record<OrbColor, string> = {
...
// Orb glow effects
export const ORB_GLOW_CLASSES: Record<OrbColor, string> = {
