...
- `mechanicalClick` → `/assets/audio/ui/mechanical-click.ogg`
- `shimmeringSuccess` → `/assets/audio/ui/shimmering-success.ogg`
- `shimmeringSuccessShort` → `/assets/audio/ui/shimmering-success-short.ogg`
- `shimmeringSuccessShorter` → `/assets/audio/ui/shimmering-success-shorter.ogg`
- `match` → `/assets/audio/ui/match.ogg`
- `bottleClink` → `/assets/audio/bg-noise/bottle-clink.ogg`
- `uncork` → `/assets/audio/ui/uncork.ogg`
- `blacksmith` → `/assets/audio/bg-noise/blacksmith.ogg`
- `blacksmithShorter` → `/assets/audio/bg-noise/blacksmith-shorter.ogg`
- `metalSharpening` → `/assets/audio/bg-noise/metal-sharpening.ogg`
- `wrong` → `/assets/audio/ui/wrong.mp3`
- `jingle` → `/assets/audio/bg-noise/jingle.ogg`
- `beep` → `/assets/audio/ui/beep.ogg`
...
- `runningUpStairs` → `/assets/audio/ui/running-up-the-stairs.ogg`
